...
exercises: 5
questions:
- "Hvordan kan man udregne summary statistics?"
- "Hvordan laver man en lineær regression?"
objectives:
- "Lær at udregne summary statistics med aggregate()"
- "Lær at udregne summary statistics med tidyverse"
- "Lær at lave en lineær regression"
keypoints:
- "Man kan udregne summary statistics på flere måder"
- "Man kan lave en lineær regression"
