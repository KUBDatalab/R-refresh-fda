...
Når vi vil bruge funktionerne, skal vi indlæse dem i R.

Når vi skal bruge pakker der ligger på CRAN gør vi følgende.
```{r eval = F}
...
Når der skal installeres pakker fra github, er processen lidt mere bøvlet.

Vi skal bruge en særlig pakke, der kan hente pakken fra Github. Men derfra er 
processen den samme.
...
ggbiplot er en pakke derbruges ret meget i dette kursus. Og det kan give udfordringer.
