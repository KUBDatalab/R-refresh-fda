...
## Mappestruktur
Lav en overskuelig mappestuktur indenfor din projektmappe. Strukturen skal håndtere forskellige typer af data, fx scripts, rå data, manipulerede data, plots, adskilt. Her under er et eksempel på en fuldt udbygget mappestruktur. 
...
```{r data-indlæsning-eksempel, eval = F}
library(readxl)
...
```{r strukturerings-eksempel, eval = F}
